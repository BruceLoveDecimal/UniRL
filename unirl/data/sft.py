...
class SupervisedDataSource:
    ...
    def __init__(
        ...
        *,
        ...
        self.manifest_fingerprint = _manifest_fingerprint(train_manifest_path)
        ...
        self._peeked: Optional[Tuple[List[Dict[str, Any]], int, int, List[int]]] = None
    ...
    def peek_samples(self, batch_size: int) -> List[Dict[str, Any]]:
        ...
        self._peeked = (batch, self._epoch, self._pos, self._order)
    ...
    def commit_peeked_samples(self) -> List[Dict[str, Any]]:
        ...
        batch, self._epoch, self._pos, self._order = self._peeked
        self._peeked = None
        return batch
